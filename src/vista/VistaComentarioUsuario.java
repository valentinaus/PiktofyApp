...
import modelo.post;
import static vista.VistaUsuario.postglobal;
import static vista.Login.correoglobal;
/**
 *
 * @author danie
 */
public class VistaComentarioUsuario extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaComentarioUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaComentarioUsuario().setVisible(true);
            }
        });
    }
